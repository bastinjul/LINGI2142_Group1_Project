...
ip address add dev Pythagore-lan1 fd00:200:1:f61f::/64 
ip address add dev Pythagore-lan1 fd00:300:1:f61f::/64 
ip link set dev Pythagore-lan0 up 
ip address add dev Pythagore-lan0 fd00:200:1:f600::/64 
ip address add dev Pythagore-lan0 fd00:300:1:f600::/64 
