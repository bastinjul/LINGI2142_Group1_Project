...
sudo ip netns exec Michotte /home/vagrant/LINGI2142_Group1_Project/firewall/internal_router.sh
...
ip address add dev lan0 fd00:200:1:f740::/64 
ip address add dev lan0 fd00:300:1:f740::/64 
