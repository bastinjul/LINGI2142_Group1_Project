...
ip6tables -A INPUT -i belneta -p icmpv6 --icmpv6-type 128/0 -j ACCEPT --match limit --limit 10/second
ip6tables -A INPUT -i belneta -p icmpv6 --icmpv6-type 128/0 -j DROP
...
do
	...
	do
		...
		ip6tables -A FORWARD -d address -p $j --dport 53 -j DROP
...
ip6tables -A INPUT -p udp -i belneta --sport 546 --dport 547 -j DROP
ip6tables -A FORWARD -p udp -i belneta --sport 546 --dport 547 -j DROP
ip6tables -A OUTPUT -p udp -o belneta --sport 546 --dport 547 -j DROP
ip6tables -A FORWARD -p udp -o belneta --sport 546 --dport 547 -j DROP
